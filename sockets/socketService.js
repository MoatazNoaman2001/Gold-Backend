...
//           resource_type: validationResult.resourceType,
//           public_id: `${Date.now()}_${user._id}`,
//         });
...
//         // Delete from cloud storage if it's a media message
//         if (message.messageType === 'media' && message.media?.publicId) {
//           try {
//             await deleteFromCloudinary(message.media.publicId);
//             // Also delete thumbnail if exists
//             if (message.media.thumbnailUrl) {
//               const thumbnailPublicId = message.media.publicId + '_thumbnail';
//               await deleteFromCloudinary(thumbnailPublicId);
//             }
//           } catch (cloudErr) {
//             console.error('Error deleting from cloud storage:', cloudErr);
